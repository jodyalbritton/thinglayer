...
definition(
    name: "The Ubi (Connect)",
    namespace: "jodyalbritton",
    author: "Jody Albritton",
    description: "The Ubi Client connect",
    category: "My Apps",
    iconUrl: "https://s3.amazonaws.com/smartapp-icons/Partner/ubi.png",
    iconX2Url: "https://s3.amazonaws.com/smartapp-icons/Partner/ubi@2x.png",
    oauth: [displayName: "The Ubi", displayLink: "The Ubi"]
) {
    appSetting "clientId"
...
preferences {
    ...
    page(name: "listUbisPage", title: "Select your Ubis", content: "listUbis", install: true)
}
