...
var demo_themes = [
  { name: 'default', title: 'Default', img: '/assets/admin/default.png' },
  { name: 'asphalt', title: 'Asphalt', img: '/assets/admin/asphalt.png' },
  { name: 'purple-hills', title: 'Purple Hills', img: '/assets/admin/purple-hills.png' },
  { name: 'adminflare',  title: 'Adminflare', img: '/assets/admin/adminflare.png' },
  { name: 'dust',  title: 'Dust', img: '/assets/admin/dust.png' },
  { name: 'frost',  title: 'Frost', img: '/assets/admin/frost.png' },
  { name: 'fresh',  title: 'Fresh', img: '/assets/admin/fresh.png' },
  { name: 'silver',  title: 'Silver', img: '/assets/admin/silver.png' },
  { name: 'clean',  title: 'Clean', img: '/assets/admin/clean.png' },
  { name: 'white',  title: 'White', img: '/assets/admin/white.png' }
];
