...
class ZonesControllerTest < ActionController::TestCase
  ...
  test "should create zone" do
    assert_difference('Zone.count') do
      post :create, zone: { ancestry: @zone.ancestry, description: @zone.description, name: @zone.name }
    end
  ...
  test "should update zone" do
    patch :update, id: @zone, zone: { ancestry: @zone.ancestry, description: @zone.description, name: @zone.name }
    assert_redirected_to zone_path(assigns(:zone))
  end
